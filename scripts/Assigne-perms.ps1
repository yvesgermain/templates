...
$connectionStrings['bd_VeilleContenuExterneEntities'] = @{Type= "SQLServer"; Value= 'Server=sqlguminterne-' + $environnement + '.database.windows.net,1433;Initial Catalog=BdVeille-'+ $environnement + ';Persist Security Info=False;User ID=sqladmin' + $environnement + ';Password=' + $passw + ';MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;ConnectionTimeout=30;App=EntityFramework'}
